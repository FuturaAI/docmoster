...
$COMPOSE_CMD -f docker-compose.prod.yml run  --name docmost-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yml -p docmost-stack up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yml -p docmost-stack up --force-recreate -d
